...
const CartPage = () => {
  ...
  return (
    <div className="h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex flex-col text-green-600 lg:flex-row">
      {/* PRODUCTS CONTAINER */}
      ...
      <div className="h-1/2 p-4 bg-fuchsia-50 flex flex-col gap-4 justify-center lg:h-full lg:w-1/3 2xl:w-1/2 lg:px-20 xl:px-40 2xl:text-xl 2xl:gap-6">
        ...
        <div className="flex justify-between">
          <span className="">Service Charge & GST</span>
        ...
        <button
          className="bg-green-600 text-white p-3 rounded-md w-1/2 self-end"
